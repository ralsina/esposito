...
void reader_view_setup_file_list(reader_state_t *state) {
    ...
    int btn_w = 5;
    ui2_button_t *btn_up = ui2_button_create(0, 0, btn_w, 3, "\xE2\x96\xB2");
    ui2_button_set_callback(btn_up, on_file_list_up_click, list);

    ui2_button_t *btn_down = ui2_button_create(0, 0, btn_w, 3, "\xE2\x96\xBC");
    ui2_button_set_callback(btn_down, on_file_list_down_click, list);

    ui2_button_t *btn_open = ui2_button_create(0, 0, btn_w, 3, "\xE2\x9C\x93");
    ui2_button_set_callback(btn_open, on_file_list_open_click, state);

    ui2_button_t *btn_get = ui2_button_create(0, 0, btn_w, 3, "\xE2\x87\xA9");
    ui2_button_set_callback(btn_get, on_file_list_get_click, state);

    ui2_button_t *btn_exit = ui2_button_create(0, 0, btn_w, 3, "\xE2\x9C\x98");
...
void reader_view_setup_reading(reader_state_t *state) {
    ...
    state->btn_jump = ui2_button_create(toc_btn_x, btn_row, btn_width, 1, "\xE2\x89\xA1");
    ui2_button_set_callback(state->btn_jump, on_reading_toc_click, state);

    state->btn_find = ui2_button_create(find_btn_x, btn_row, btn_width, 1, "\xE2\x8C\x95");
    ui2_button_set_callback(state->btn_find, on_reading_find_click, state);

    state->btn_goto = ui2_button_create(goto_btn_x, btn_row, btn_width, 1, "\xE2\x96\xB6");
    ui2_button_set_callback(state->btn_goto, on_reading_goto_click, state);

    state->btn_back = ui2_button_create(back_btn_x, btn_row, btn_width, 1, "\xE2\x9C\x98");
